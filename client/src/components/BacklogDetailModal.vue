      ...
      <div v-if="isOpen && backlogItem" class="modal-overlay" @click="close">
        <div class="modal-container" @click.stop>
          <div class="modal-header">
            <h3 class="modal-title">{{ t('modal.inventoryShortageDetails') }}</h3>
          ...
          <div class="modal-body">
            <div class="shortage-header">
              ...
              <span class="priority-badge" :class="backlogItem.priority">
                {{ t(`priority.${backlogItem.priority}`) }} {{ t('modal.priority') }}
              </span>
            </div>

            <div class="shortage-summary">
              <div class="summary-card danger">
                <div class="summary-label">{{ t('modal.shortageAmount') }}</div>
                <div class="summary-value">{{ shortage }} {{ t('common.units') }}</div>
              </div>
              <div class="summary-card warning">
                <div class="summary-label">{{ t('modal.daysDelayed') }}</div>
            ...
            <div class="info-grid">
              ...
              <div class="info-item">
                ...
                <div class="info-value">
                  <span class="badge danger">{{ t('modal.backordered') }}</span>
                </div>
              </div>
            </div>
          </div>
