      ...
      <div v-if="isOpen && costData" class="modal-overlay" @click="close">
        <div class="modal-container" @click.stop>
          <div class="modal-header">
            <h3 class="modal-title">{{ costData.month }} {{ t('modal.costBreakdown') }}</h3>
          ...
          <div class="modal-body">
            <div class="cost-summary">
              <div class="summary-card total">
                <div class="summary-label">{{ t('modal.totalCosts') }}</div>
            ...
            <div class="cost-breakdown">
              <div class="cost-item procurement">
                <div class="cost-header">
                  ...
                  <div class="cost-info">
                    <div class="cost-name">{{ t('modal.procurement') }}</div>
              ...
              <div class="cost-item operational">
                <div class="cost-header">
                  ...
                  <div class="cost-info">
                    <div class="cost-name">{{ t('modal.operational') }}</div>
              ...
              <div class="cost-item labor">
                <div class="cost-header">
                  ...
                  <div class="cost-info">
                    <div class="cost-name">{{ t('modal.labor') }}</div>
              ...
              <div class="cost-item overhead">
                <div class="cost-header">
                  ...
                  <div class="cost-info">
                    <div class="cost-name">{{ t('modal.overhead') }}</div>
