      ...
      <div v-if="isOpen && inventoryItem" class="modal-overlay" @click="close">
        <div class="modal-container" @click.stop>
          <div class="modal-header">
            <h3 class="modal-title">{{ t('modal.inventoryItemDetails') }}</h3>
          ...
          <div class="modal-body">
            ...
            <div class="stock-summary">
              <div class="summary-card primary">
                <div class="summary-label">{{ t('modal.quantityOnHand') }}</div>
              ...
              <div class="summary-card" :class="getSummaryCardClass()">
                <div class="summary-label">{{ t('modal.stockLevel') }}</div>
                <div class="summary-value">{{ stockPercentage }}%</div>
                <div class="summary-subtitle">{{ t('modal.vsReorderPoint') }}</div>
              </div>
            </div>

            <div class="info-grid">
              <div class="info-item">
                <div class="info-label">{{ t('modal.category') }}</div>
                <div class="info-value">{{ inventoryItem.category }}</div>
              </div>

              <div class="info-item">
                <div class="info-label">{{ t('modal.location') }}</div>
                <div class="info-value">{{ inventoryItem.location }}</div>
              </div>

              <div class="info-item">
                <div class="info-label">{{ t('modal.reorderPoint') }}</div>
                <div class="info-value">{{ inventoryItem.reorder_point }} {{ t('common.units') }}</div>
              </div>

              <div class="info-item">
                <div class="info-label">{{ t('modal.unitsRemaining') }}</div>
              ...
              <div class="info-item">
                <div class="info-label">{{ t('modal.unitCost') }}</div>
                <div class="info-value">{{ currencySymbol }}{{ inventoryItem.unit_cost.toFixed(2) }}</div>
              </div>

              <div class="info-item">
                <div class="info-label">{{ t('modal.totalValue') }}</div>
              ...
              <div class="info-item">
                <div class="info-label">{{ t('modal.warehouse') }}</div>
                <div class="info-value">{{ translateWarehouse(inventoryItem.location) }}</div>
              </div>

              <div class="info-item">
                <div class="info-label">{{ t('modal.status') }}</div>
                <div class="info-value">
